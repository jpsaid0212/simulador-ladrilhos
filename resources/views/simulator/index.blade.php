...
function simuladorDP(){
  return {
    modo: 'ladrilho',
    categorias: ['Centrais','Geométricos','Florões','Abstratos','Listras','Números'],
    categoriaAtiva: 'Centrais',

    templates: [

      // === CENTRAIS ===
      { id:'animal-print', type:'raster', nome:'Animal Print', categoria:'Centrais', src: "{{ asset('simulator/patterns/ANIMAL PRINT.svg') }}" },
      { id:'andorinha', type:'raster', nome:'Andorinha', categoria:'Centrais', src: "{{ asset('simulator/patterns/ANDORINHA.svg') }}" },
      { id:'andorinha-2', type:'raster', nome:'Andorinha 2', categoria:'Centrais', src: "{{ asset('simulator/patterns/andorinha-2.svg') }}" },
      { id:'rita-lee', type:'raster', nome:'Rita Lee', categoria:'Centrais', src: "{{ asset('simulator/patterns/RITA LEE.svg') }}" },
      { id:'ankh', type:'raster', nome:'Ankh', categoria:'Centrais', src: "{{ asset('simulator/patterns/ANKH.svg') }}" },
      { id:'balao', type:'raster', nome:'Balão', categoria:'Centrais', src: "{{ asset('simulator/patterns/balao.svg') }}" },
      { id:'bandeirinha', type:'raster', nome:'Bandeirinha', categoria:'Centrais', src: "{{ asset('simulator/patterns/Bandeirinha.svg') }}" },
      { id:'bola-1', type:'raster', nome:'Bola', categoria:'Centrais', src: "{{ asset('simulator/patterns/bola-1.svg') }}" },
      { id:'bolas', type:'raster', nome:'Bolas', categoria:'Centrais', src: "{{ asset('simulator/patterns/bolas.svg') }}" },
      { id:'bolinhas', type:'raster', nome:'Bolinhas', categoria:'Centrais', src: "{{ asset('simulator/patterns/BOLINHAS.svg') }}" },
      { id:'bola-70s', type:'raster', nome:'Bola 70s', categoria:'Centrais', src: "{{ asset('simulator/patterns/BOLA 70 s.svg') }}" },
      { id:'brotos', type:'raster', nome:'Brotos', categoria:'Centrais', src: "{{ asset('simulator/patterns/brotos.svg') }}" },
      { id:'centro-arabe-2', type:'raster', nome:'Centro Árabe', categoria:'Centrais', src: "{{ asset('simulator/patterns/centro-arabe-2.svg') }}" },
      { id:'circulos', type:'raster', nome:'Círculos', categoria:'Centrais', src: "{{ asset('simulator/patterns/CIRCULOS.svg') }}" },
      { id:'colmeia', type:'raster', nome:'Colmeia', categoria:'Centrais', src: "{{ asset('simulator/patterns/colmeia.svg') }}" },
      { id:'colmeia-2', type:'raster', nome:'Colmeia 2', categoria:'Centrais', src: "{{ asset('simulator/patterns/colmeia-2.svg') }}" },
      { id:'4-bolas-colmeia', type:'raster', nome:'4 Bolas Colmeia', categoria:'Centrais', src: "{{ asset('simulator/patterns/4-bolas-colmeia-maior-1.svg') }}" },
      { id:'face', type:'raster', nome:'Face', categoria:'Centrais', src: "{{ asset('simulator/patterns/face.svg') }}" },
      { id:'meia-cara', type:'raster', nome:'Meia Cara Composto', categoria:'Centrais', src: "{{ asset('simulator/patterns/meia_cara_composto.svg') }}" },
      { id:'margarida', type:'raster', nome:'Margarida Simples', categoria:'Centrais', src: "{{ asset('simulator/patterns/margarida-simples.svg') }}" },
      { id:'netuno', type:'raster', nome:'Netuno', categoria:'Centrais', src: "{{ asset('simulator/patterns/netuno.svg') }}" },
      { id:'ovos', type:'raster', nome:'Ovos', categoria:'Centrais', src: "{{ asset('simulator/patterns/ovos.svg') }}" },
      { id:'pingos', type:'raster', nome:'Pingos', categoria:'Centrais', src: "{{ asset('simulator/patterns/pingos.svg') }}" },
      { id:'sol-1', type:'raster', nome:'Sol', categoria:'Centrais', src: "{{ asset('simulator/patterns/sol-1.svg') }}" },
      { id:'tigela', type:'raster', nome:'Tigela', categoria:'Centrais', src: "{{ asset('simulator/patterns/TIGELA.svg') }}" },
      { id:'x-simples', type:'raster', nome:'X Simples', categoria:'Centrais', src: "{{ asset('simulator/patterns/x-simples.svg') }}" },

      // === GEOMÉTRICOS ===
      { id:'blocos', type:'raster', nome:'Blocos', categoria:'Geométricos', src: "{{ asset('simulator/patterns/BLOCOS.svg') }}" },
      { id:'colors', type:'raster', nome:'Colors', categoria:'Geométricos', src: "{{ asset('simulator/patterns/COLORS.svg') }}" },
      { id:'cubo-escher', type:'raster', nome:'Cubo do Escher', categoria:'Geométricos', src: "{{ asset('simulator/patterns/Cubo do Escher.svg') }}" },
      { id:'cubo-escher-2', type:'raster', nome:'Cubo do Escher 2', categoria:'Geométricos', src: "{{ asset('simulator/patterns/Cubo do Escher 2.svg') }}" },
      { id:'egipt', type:'raster', nome:'Egipt', categoria:'Geométricos', src: "{{ asset('simulator/patterns/EGIPT.svg') }}" },
      { id:'geo-07', type:'raster', nome:'Geo 07', categoria:'Geométricos', src: "{{ asset('simulator/patterns/GEO 07.svg') }}" },
      { id:'geo-14', type:'raster', nome:'Geo 14', categoria:'Geométricos', src: "{{ asset('simulator/patterns/GEO 14.svg') }}" },
      { id:'geo-29', type:'raster', nome:'Geo 29', categoria:'Geométricos', src: "{{ asset('simulator/patterns/GEO 29.svg') }}" },
      { id:'geo-43', type:'raster', nome:'Geo 43', categoria:'Geométricos', src: "{{ asset('simulator/patterns/GEO 43.svg') }}" },
      { id:'geo-51', type:'raster', nome:'Geo 51', categoria:'Geométricos', src: "{{ asset('simulator/patterns/GEO 51.svg') }}" },
      { id:'geo-104', type:'raster', nome:'Geo 104', categoria:'Geométricos', src: "{{ asset('simulator/patterns/GEO 104.svg') }}" },
      { id:'geo-canto', type:'raster', nome:'Geométrico Canto', categoria:'Geométricos', src: "{{ asset('simulator/patterns/GEOMETRICO CANTO.svg') }}" },
      { id:'gobeto', type:'raster', nome:'Gobeto', categoria:'Geométricos', src: "{{ asset('simulator/patterns/gobeto.svg') }}" },
      { id:'gobeto-1', type:'raster', nome:'Gobeto 1', categoria:'Geométricos', src: "{{ asset('simulator/patterns/gobeto-1.svg') }}" },
      { id:'gobeto2-1', type:'raster', nome:'Gobeto 2', categoria:'Geométricos', src: "{{ asset('simulator/patterns/gobeto2-1.svg') }}" },
      { id:'latitude', type:'raster', nome:'Latitude', categoria:'Geométricos', src: "{{ asset('simulator/patterns/LATITUDE.svg') }}" },
      { id:'marrocos', type:'raster', nome:'Marrocos', categoria:'Geométricos', src: "{{ asset('simulator/patterns/MARROCOS.svg') }}" },
      { id:'mooca', type:'raster', nome:'Mooca', categoria:'Geométricos', src: "{{ asset('simulator/patterns/MOOCA.svg') }}" },
      { id:'nove-quadrados', type:'raster', nome:'Nove Quadrados', categoria:'Geométricos', src: "{{ asset('simulator/patterns/NOVE QUADRADOS.svg') }}" },
      { id:'ovus-ii', type:'raster', nome:'Ovus II', categoria:'Geométricos', src: "{{ asset('simulator/patterns/OVUS II.svg') }}" },
      { id:'seixos', type:'raster', nome:'Seixos', categoria:'Geométricos', src: "{{ asset('simulator/patterns/SEIXOS.svg') }}" },
      { id:'tabuleiro', type:'raster', nome:'Tabuleiro', categoria:'Geométricos', src: "{{ asset('simulator/patterns/TABULEIRO.svg') }}" },
      { id:'tiradentes', type:'raster', nome:'Tiradentes', categoria:'Geométricos', src: "{{ asset('simulator/patterns/TIRADENTES.svg') }}" },
      { id:'triangulo', type:'raster', nome:'Triângulo', categoria:'Geométricos', src: "{{ asset('simulator/patterns/triangulo.svg') }}" },
      { id:'triangulo-unico', type:'raster', nome:'Triângulo Único', categoria:'Geométricos', src: "{{ asset('simulator/patterns/TRIANGULO UNICO.svg') }}" },
      { id:'variavel-zero', type:'raster', nome:'Variável Zero', categoria:'Geométricos', src: "{{ asset('simulator/patterns/VARIAVEL ZERO.svg') }}" },
      { id:'volos', type:'raster', nome:'Volos', categoria:'Geométricos', src: "{{ asset('simulator/patterns/VOLOS.svg') }}" },
      { id:'zig', type:'raster', nome:'Zig', categoria:'Geométricos', src: "{{ asset('simulator/patterns/ZIG.svg') }}" },
      { id:'2d', type:'raster', nome:'2D', categoria:'Geométricos', src: "{{ asset('simulator/patterns/2D.svg') }}" },

      // === FLORÕES ===
      { id:'estrela-um', type:'raster', nome:'Estrela Um', categoria:'Florões', src: "{{ asset('simulator/patterns/ESTRELA UM.svg') }}" },
      { id:'estrela-2', type:'raster', nome:'Estrela 2', categoria:'Florões', src: "{{ asset('simulator/patterns/ESTRELA 2.svg') }}" },
      { id:'estrela-8', type:'raster', nome:'Estrela 8', categoria:'Florões', src: "{{ asset('simulator/patterns/ESTRELA 8.svg') }}" },
      { id:'estrela-10', type:'raster', nome:'Estrela 10', categoria:'Florões', src: "{{ asset('simulator/patterns/ESTRELA 10.svg') }}" },
      { id:'folha-ii', type:'raster', nome:'Folha II', categoria:'Florões', src: "{{ asset('simulator/patterns/FOLHA II.svg') }}" },
      { id:'folha-v', type:'raster', nome:'Folha V', categoria:'Florões', src: "{{ asset('simulator/patterns/FOLHA V.svg') }}" },
      { id:'leque', type:'raster', nome:'Leque', categoria:'Florões', src: "{{ asset('simulator/patterns/LEQUE.svg') }}" },
      ...
      { id:'cyber-cafe-i', type:'raster', nome:'Cyber Cafe I', categoria:'Abstratos', src: "{{ asset('simulator/patterns/CYBER CAFE I.svg') }}" },
      { id:'cyber-cafe-ii', type:'raster', nome:'Cyber Cafe II', categoria:'Abstratos', src: "{{ asset('simulator/patterns/CYBER CAFE II.svg') }}" },
      { id:'de-quem-e-esse-chao', type:'raster', nome:'De Quem É Esse Chão', categoria:'Abstratos', src: "{{ asset('simulator/patterns/De quem é esse chao.svg') }}" },
      { id:'fabs', type:'raster', nome:'Fabs', categoria:'Abstratos', src: "{{ asset('simulator/patterns/FABS.svg') }}" },
      { id:'madrid-2030', type:'raster', nome:'Madrid 2030', categoria:'Abstratos', src: "{{ asset('simulator/patterns/MADRID 2030.svg') }}" },
      { id:'maos-ii', type:'raster', nome:'Mãos II', categoria:'Abstratos', src: "{{ asset('simulator/patterns/MAOS II.svg') }}" },
      { id:'praia-do-una', type:'raster', nome:'Praia do Una', categoria:'Abstratos', src: "{{ asset('simulator/patterns/PRAIA DO UNA.svg') }}" },

      // === LISTRAS ===
      { id:'listras', type:'raster', nome:'Listras', categoria:'Listras', src: "{{ asset('simulator/patterns/LISTRAS.svg') }}" },
      { id:'listras-2', type:'raster', nome:'Listras 2', categoria:'Listras', src: "{{ asset('simulator/patterns/LISTRAS 2.svg') }}" },
      { id:'tres-listras', type:'raster', nome:'Três Listras', categoria:'Listras', src: "{{ asset('simulator/patterns/TRES LISTRAS.svg') }}" },
      { id:'linha', type:'raster', nome:'Linha', categoria:'Listras', src: "{{ asset('simulator/patterns/linha.svg') }}" },
      ...
      { id:'2075-1', type:'raster', nome:'2075', categoria:'Números', src: "{{ asset('simulator/patterns/2075-1.svg') }}" },
      { id:'2078-1', type:'raster', nome:'2078', categoria:'Números', src: "{{ asset('simulator/patterns/2078-1.svg') }}" },
      { id:'2097-1', type:'raster', nome:'2097', categoria:'Números', src: "{{ asset('simulator/patterns/2097-1.svg') }}" },
      { id:'2107-1', type:'raster', nome:'2107', categoria:'Números', src: "{{ asset('simulator/patterns/2107-1.svg') }}" },
      { id:'2133-1', type:'raster', nome:'2133', categoria:'Números', src: "{{ asset('simulator/patterns/2133-1.svg') }}" },
      { id:'2140-1', type:'raster', nome:'2140', categoria:'Números', src: "{{ asset('simulator/patterns/2140-1.svg') }}" },
      { id:'2144-1', type:'raster', nome:'2144', categoria:'Números', src: "{{ asset('simulator/patterns/2144-1.svg') }}" },
      { id:'2146-1', type:'raster', nome:'2146', categoria:'Números', src: "{{ asset('simulator/patterns/2146-1.svg') }}" },
      { id:'2172-1', type:'raster', nome:'2172', categoria:'Números', src: "{{ asset('simulator/patterns/2172-1.svg') }}" },
      { id:'2182-1', type:'raster', nome:'2182', categoria:'Números', src: "{{ asset('simulator/patterns/2182-1.svg') }}" },
      { id:'2208-1', type:'raster', nome:'2208', categoria:'Números', src: "{{ asset('simulator/patterns/2208-1.svg') }}" },
      { id:'4014-2', type:'raster', nome:'4014', categoria:'Números', src: "{{ asset('simulator/patterns/4014-2.svg') }}" },
      { id:'4051-1', type:'raster', nome:'4051', categoria:'Números', src: "{{ asset('simulator/patterns/4051-1 (1).svg') }}" },
      { id:'4055-2', type:'raster', nome:'4055', categoria:'Números', src: "{{ asset('simulator/patterns/4055-2.svg') }}" },
      { id:'4063-2', type:'raster', nome:'4063', categoria:'Números', src: "{{ asset('simulator/patterns/4063-2.svg') }}" },
      { id:'4064-1', type:'raster', nome:'4064', categoria:'Números', src: "{{ asset('simulator/patterns/4064-1.svg') }}" },
      { id:'4068-1', type:'raster', nome:'4068', categoria:'Números', src: "{{ asset('simulator/patterns/4068-1.svg') }}" },
      { id:'4112-1', type:'raster', nome:'4112', categoria:'Números', src: "{{ asset('simulator/patterns/4112-1.svg') }}" },
      { id:'4125-1', type:'raster', nome:'4125', categoria:'Números', src: "{{ asset('simulator/patterns/4125-1.svg') }}" },
      { id:'4193-1', type:'raster', nome:'4193', categoria:'Números', src: "{{ asset('simulator/patterns/4193-1.svg') }}" },
      { id:'4310-1', type:'raster', nome:'4310', categoria:'Números', src: "{{ asset('simulator/patterns/4310-1.svg') }}" },
      { id:'4312-1', type:'raster', nome:'4312', categoria:'Números', src: "{{ asset('simulator/patterns/4312-1.svg') }}" }
    ],
